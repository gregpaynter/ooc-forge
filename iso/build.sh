...
# Stage the canonical Forge source into the image without copying build artefacts
# or repository metadata. The live image installs from this local source only.
